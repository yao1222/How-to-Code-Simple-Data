...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname space-invaders-starter_raw) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define LOM2 (list (make-missile 100 100) (make-missile 200 200))) ;list with 2 missile
